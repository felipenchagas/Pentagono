...
/* tools.html.twig */
class __TwigTemplate_f4d03e444daf776b0a7b3c323d183f9e03abcfb199bf98d3ef5d6656953b67f0 extends Twig_Template
{
    ...
    {
        // line 3
        $context["tools_slug"] = twig_escape_filter($this->env, $this->getAttribute((isset($context["uri"]) ? $context["uri"] : null), "basename", array()));
        // line 4
        if (((isset($context["tools_slug"]) ? $context["tools_slug"] : null) == "tools")) {
            $context["tools_slug"] = "direct-install";
        }
        // line 5
        $context["title"] = (($this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.TOOLS") . ": ") . $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter(("PLUGIN_ADMIN." . twig_upper_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->inflectorFilter("underscor", (isset($context["tools_slug"]) ? $context["tools_slug"] : null))))));
        // line 1
    ...
    public function block_titlebar($context, array $blocks = array())
    {
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter(("PLUGIN_ADMIN." . twig_upper_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->inflectorFilter("underscor", (isset($context["tools_slug"]) ? $context["tools_slug"] : null))))), "html", null, true);
        echo "</h1>
";
    }
    ...
    ";
        // line 13
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "tools", array())) > 1)) {
            // line 14
            echo "
    <div class=\"form-tabs\">
        <div class=\"tabs-nav\">
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        if ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize(array(0 => "admin.tools", 1 => "admin.super"))) {
            ...
            echo "        ";
            try {
                $this->loadTemplate((("partials/tools-" . (isset($context["tools_slug"]) ? $context["tools_slug"] : null)) . ".html.twig"), "tools.html.twig", 30)->display($context);
...
", "tools.html.twig", "/home/penta/public_html/servicos/user/plugins/admin/themes/grav/templates/tools.html.twig");
    }
}
