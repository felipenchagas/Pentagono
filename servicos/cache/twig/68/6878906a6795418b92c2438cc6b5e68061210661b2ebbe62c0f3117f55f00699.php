...
class __TwigTemplate_4fda3ff2e45a3b1e43c3ce8a288b4efc819190f313f4409f70a2dd4be369c0ff extends Twig_Template
{
        ...
        if (twig_length_filter($this->env, (isset($context["value"]) ? $context["value"] : null))) {
            ...
            foreach ($context['_seq'] as $context["key"] => $context["content"]) {
                ...
                echo "<div class=\"element-wrapper\">
                    ";
                // line 98
                echo $context["macro"]->getrenderer($context["key"], $context["content"], (isset($context["field"]) ? $context["field"] : null), (isset($context["scope"]) ? $context["scope"] : null), 0, (("[" . $context["key"]) . "]"), true);
                echo "
                </div>
            ";
            }
...
";
    ...
    public function getfield($__value__ = null, $__key__ = null, $__level__ = null, $__globalvars__ = null, $__disable_name__ = null, $__hidden__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            data-grav-array-type=\"row\" ";
            // line 9
            if (((((isset($context["hidden"]) || array_key_exists("hidden", $context))) ? (_twig_default_filter((isset($context["hidden"]) ? $context["hidden"] : null), false)) : (false)) == true)) {
    ...
    ";
        ...
        ";
                // line 26
                echo $context["self"]->getfield((isset($context["key"]) ? $context["key"] : null), "", (isset($context["level"]) ? $context["level"] : null), $context, true, ((is_numeric((isset($context["key"]) ? $context["key"] : null))) ? (true) : (false)));
                echo "
        ...
        ";
            ...
            <div class=\"children-wrapper\">
                <div class=\"element-wrapper\">
                    ";
                    // line 33
                    echo $context["self"]->getfield((isset($context["content"]) ? $context["content"] : null), (("[" . (isset($context["key"]) ? $context["key"] : null)) . "]"), (isset($context["level2"]) ? $context["level2"] : null), $context);
                    echo "
                </div>
            </div>
        ";
            ...
            foreach ($context['_seq'] as $context["inner_key"] => $context["inner_content"]) {
                ...
                if ( !is_numeric($context["inner_key"])) {
                    ...
                    if ((twig_length_filter($this->env, (isset($context["content"]) ? $context["content"] : null)) > 1)) {
                        // line 49
                        echo "                        ";
                        echo $context["self"]->getfield($context["inner_key"], (isset($context["parent_key"]) ? $context["parent_key"] : null), (isset($context["level"]) ? $context["level"] : null), $context, true);
                        echo "
                    ";
                    } else {
                        // line 51
                        echo "                        ";
                        echo $context["self"]->getfield($context["inner_key"], (isset($context["parent_key"]) ? $context["parent_key"] : null), (isset($context["level"]) ? $context["level"] : null), $context);
                        echo "
                    ";
                    }
                    // line 53
                ...
                if ( !twig_test_iterable($context["inner_content"])) {
                    ...
                    // line 68
                    echo "                    ";
                    echo $context["self"]->getfield($context["inner_content"], ((((isset($context["parent_key"]) ? $context["parent_key"] : null) . "[") . $context["inner_key"]) . "]"), (isset($context["level2"]) ? $context["level2"] : null), $context);
                    echo "
                    ...
                    // line 77
                    echo "                    ";
                    echo $context["self"]->getrenderer($context["inner_key"], $context["inner_content"], (isset($context["field"]) ? $context["field"] : null), (isset($context["scope"]) ? $context["scope"] : null), (isset($context["level"]) ? $context["level"] : null), (isset($context["inner_parent_key"]) ? $context["inner_parent_key"] : null), (isset($context["up_level"]) ? $context["up_level"] : null));
                    echo "
                ";
                }
                // line 79
...
{% endblock %}
", "forms/fields/multilevel/multilevel.html.twig", "/home/penta/public_html/servicos/user/plugins/admin/themes/grav/templates/forms/fields/multilevel/multilevel.html.twig");
    }
}
