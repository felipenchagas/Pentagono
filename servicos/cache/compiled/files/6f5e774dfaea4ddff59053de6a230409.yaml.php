...
return [
    ...
    'filename' => '/home/penta/public_html/servicos/user/plugins/admin/languages/el.yaml',
    'modified' => 1541106083,
    'data' => [
        'PLUGIN_ADMIN' => [
            ...
            'SITE_DEFAULT_LANG_PLACEHOLDER' => 'Προεπιλεγμένη γλώσσα που θα χρησιμοποιείται από <html lang="pt-br"> tag του θέματος',
            'SITE_DEFAULT_LANG_HELP' => 'Προεπιλεγμένη γλώσσα που θα χρησιμοποιείται από <html lang="pt-br"> tag του θέματος',
