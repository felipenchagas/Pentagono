...
try {
     ...
     $mail->Host = 'mail.pentagonoalpinismo.com.br'; // Endereço do servidor SMTP (Autenticação, utilize o host smtp.seudomínio.com.br)
     $mail->SMTPAuth   = true;  // Usar autenticação SMTP (obrigatório para smtp.seudomínio.com.br)
     $mail->Port       = 587; //  Usar 587 porta SMTP
     $mail->Username = 'comercial@pentagonoalpinismo.com.br'; // Usuário do servidor SMTP (endereço de email)
     $mail->Password = 'ma2112'; // Senha do servidor SMTP (senha do email usado)
$mail->AddAddress('comercial@pentagonoalpinismo.com.br', 'TURF GRASS');
     //Define o remetente
     // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=    
     $mail->SetFrom('comercial@pentagonoalpinismo.com.br', 'Site'); //Seu e-mail
     $mail->AddReplyTo('comercial@pentagonoalpinismo.com.br', 'Nome'); //Seu e-mail
	
     $mail->Subject = "CONTATO - SITE - # $orcamento";//Assunto do e-mail	 
    $mail->isHTML(true);
